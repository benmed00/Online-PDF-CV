/**
 * Client-side job description matcher (mirrors utils/jobDescriptionMatcher.js for offline fallback).
 */
const JobDescriptionMatcher = (function () {
  ...
  return { extractRequirements, matchResumeToJob, MAX_JOB_DESCRIPTION_CHARS };
})();

if (typeof window !== 'undefined') {
  window.JobDescriptionMatcher = JobDescriptionMatcher;
}
